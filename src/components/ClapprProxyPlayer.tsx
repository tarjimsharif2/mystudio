...
export const ClapprProxyPlayer = ({
  ...
  const initPlayer = useCallback(() => {
    ...
    // Use the provided streamUrl directly (it's already proxied by our backend if needed)
    ...
    <div className="relative w-full h-full bg-black overflow-hidden">
      ...
      {error && (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black p-8 text-center">
          ...
          <h3 className="mb-2 text-lg font-bold text-white">Transmission Error</h3>
          <p className="mb-6 max-w-xs text-sm text-gray-400">{error}</p>
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <button 
              ...
              className="inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-gray-700 bg-transparent shadow-sm hover:bg-gray-800 text-white h-9 px-4 py-2"
            >
              Go Back
            </button>
          </div>
